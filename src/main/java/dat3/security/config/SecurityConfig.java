...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
    ...
    http.authorizeHttpRequests((authorize) -> authorize
            ...
            .requestMatchers(mvcMatcherBuilder.pattern("/add")).hasAuthority("USER")

            .requestMatchers(mvcMatcherBuilder.pattern("/recipes")).permitAll()

            .requestMatchers(mvcMatcherBuilder.pattern("/categories")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern("/info")).permitAll()
            .requestMatchers(mvcMatcherBuilder.pattern("/recipes/*")).permitAll()

            .requestMatchers(mvcMatcherBuilder.pattern("/newCategory")).hasAuthority("ADMIN")
